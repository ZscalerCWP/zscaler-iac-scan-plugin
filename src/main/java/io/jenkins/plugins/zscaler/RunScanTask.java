...
public class RunScanTask extends MasterToSlaveCallable<Object, RuntimeException> {
    ...
    public Object call() throws RuntimeException {
        try {
            return runScan(listener, buildDetails, workspace.toURI().getPath());
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }

    private String runScan(TaskListener listener, BuildDetails buildDetails, String workspace) throws IOException {
        ...
        try {
            String[] command = {
                    ...
                    workspace,
                    "--sub-type",
                    String.valueOf(buildDetails.getSubType()),
                    "--event-id",
